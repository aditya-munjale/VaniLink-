              ...
              <ReactMarkdown
                components={{
                  ...
                  ul: ({ node, children, ...props }) => (
                    <ul
                      className="list-disc pl-5 sm:pl-6 space-y-2 sm:space-y-3 my-4 marker:text-purple-500"
                      {...props}
                    >
                      {children}
                    </ul>
                  ...
                  h3: ({ node, children, ...props }) => (
                    <h3
                      className="text-xl sm:text-2xl font-bold mt-6 sm:mt-8 mb-2 sm:mb-3 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400"
                      {...props}
                    >
                      {children}
                    </h3>
                  ...
                  p: ({ node, children, ...props }) => (
                    <p className="mb-3 sm:mb-4 text-sm sm:text-base" {...props}>
                      {children}
                    </p>
                  ),
                }}
